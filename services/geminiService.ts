...
`;
  ...
  try {
    ...
    // ✅ SDK-safe extraction (prevents undefined crash)
    const rawText =
      response.text ||
    ...
    console.error("Gemini JSON parse / request error:", err);

    // cleaner surfaced error for UI
